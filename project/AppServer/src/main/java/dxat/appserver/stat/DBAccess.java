...
public class DBAccess {
	...
	public RrdDef createRrdDefController(long start) {
		...
		rrdDef.setVersion(2);
		rrdDef.addDatasource("CpuAvg", GAUGE, 600, 0, 0);
		rrdDef.addDatasource("MemoryPCT", GAUGE, 600, 0, 0);
	...
	public RrdDef createRrdDefPort(String name, long start) {
		...
		RrdDef rrdDef = new RrdDef(path, start - 1, 1);
		rrdDef.setVersion(2);
		rrdDef.addDatasource("receivePackets", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("transmitPackets", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("receiveBytes", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("transmitBytes", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("receiveDropped", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("transmitDropped", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("receiveErrors", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("transmitErrors", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("receiveFrameErrors", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("receiveOverrunErrors", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("receiveCRCErrors", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("collisions", DERIVE, 600, 0, 0);
	...
	public RrdDef createRrdDefSwitch(String name, long start) {
		...
		RrdDef rrdDef = new RrdDef(path, start - 1, 1);
		rrdDef.setVersion(2);
		rrdDef.addDatasource("packetCount", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("byteCount", DERIVE, 600, 0, 0);
		rrdDef.addDatasource("flowCount", DERIVE, 600, 0, 0);
		rrdDef.addArchive(AVERAGE, 0.5, 1, 60);
		rrdDef.addArchive(AVERAGE, 0.5, 60, 1140);
		rrdDef.addArchive(AVERAGE, 0.5, 3600, 24);
		rrdDef.addArchive(MAX, 0.5, 1, 60);
