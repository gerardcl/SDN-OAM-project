...
public class LinkTopologyDB extends TopologyDB {
    ...
    public void opendb() throws CannotOpenDataBaseException {
        super.opendb();
        ResourceIterator<Node> linkManager = graphDb.findNodesByLabelAndProperty(
                DynamicLabel.label(Managers.LINK_MANAGER), ID_PROPERTY, Managers.LINK_MANAGER).iterator();
