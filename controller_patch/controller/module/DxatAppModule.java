...
import dxat.controller.module.stats.StatisticsThread;
...
public class DxatAppModule implements IFloodlightModule {
    ...
    /**
     * Service instance related with the discovery of new network devices (Terminals)
     */
    ...
    /**
     * Service instance related with the management of the switches and OpenFlow messages.
     */
    ...
    /**
     * Service instance related with the flow push. It is needed for push, delete and monitor flows.
     */
    ...
    /**
     * This function return the instance of the DxatAppModule with all the required services.
    ...
    public void init(FloodlightModuleContext context)
        ...
        linkListener = new LinkListener(moduleServerThread,
                linkService);
        linkService.addListener(linkListener);

        // Switch Listener Initialization
        switchListener = new SwitchListener(moduleServerThread,
                switchService);
        ...
        //switchService.addOFMessageListener(OFType.PACKET_IN , packetListener);

        // Create module of statistics
        // Start Statistics thread
        statisticsThread = new StatisticsThread();
        Thread thread = new Thread(statisticsThread, "Statistics Module Thread");
        thread.start();
    }
